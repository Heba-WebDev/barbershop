                        ...
                        <CarouselItem key={`${item.name}-${index}`} className="relative">
                            <div className="absolute z-10 top-24 left-10">
                                <h2 className="text-purple-200
                                                ...
                                                px-5 py-3 rounded-t-xl rounded-r-xl border border-indigo-400
                                                mb-1">
                                    {item.name}</h2>
                                <a className=" bg-gradient-to-r from-indigo-500 to-purple-600
                                    px-7 py-1.5 rounded-b-xl top-44 left-8 text-purple-100 text-lg" href="#">
                                    ¡Ir a barbería!</a>
                            </div>
                            
                            <img src={item.img} className=" opacity-40 rounded-xl"/>
